...
from backend.src.crawler.crawler_base import NewsCrawlerBase, News, Headline
...
class TestNewsCrawlerBase(unittest.TestCase):
    ...
    def test_validate_and_parse_raises_domain_mismatch(self):
        invalid_url = "https://www.bad.com/article"
    ...
    @patch('backend.src.crawler.crawler_base.Session', create=True)
